...
public class ItemRequestsClient extends BaseClient {
    ...
    public ResponseEntity<Object> addItemRequest(ItemRequestInDto itemRequestInDto, Long userId) {
        String url = "";
        return post(url, userId, itemRequestInDto);
    }

    public ResponseEntity<Object> getAllMineRequests(Long userId) {
        String url = "";
